...
def main():
    ...
    try:
        ...
        current_spec = {
            'markdown': parser.parse_markdown(md_content),
            'json': parser.parse_json_schema(json_schema)
        }
        ...
        print(f"✅ No-change scenario validation passed")
        ...
        print(f"✅ Change scenario validation passed")
        ...
        print(f"✅ Summary report validation passed")
        ...
        print(f"✅ JSON export validation passed")
        ...
        breaking_report = generator.generate_report(
            ...
            coverage_analysis,
            "Previous A2A Spec",
            "Current A2A Spec (Breaking Changes)"
        )
        ...
        print(f"✅ Breaking changes scenario validation passed")
