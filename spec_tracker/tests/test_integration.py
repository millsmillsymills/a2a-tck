...
def test_main_script_help():
    ...
    result = subprocess.run([sys.executable, "spec_tracker/main.py", "--help"], capture_output=True, text=True, check=False)
...
def test_main_script_dry_run():
    ...
    result = subprocess.run([sys.executable, "spec_tracker/main.py", "--dry-run"], capture_output=True, text=True, check=False)
