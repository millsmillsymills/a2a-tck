        ...
        try:
            ...
            if hasattr(e, "json_rpc_error") and e.json_rpc_error:
                ...
                if error_code == -32003:
                    ...
                    pytest.fail(
                        f"Expected PushNotificationNotSupportedError (-32003) or MethodNotFoundError (-32601), got {error_code}"
                    )
            else:
...
def test_content_type_not_supported_error_32005(sut_client):
    ...
    params = {
        "message": message_data,
        "configuration": {"acceptedOutputModes": ["application/x-completely-unsupported-output-format"]},
    }
