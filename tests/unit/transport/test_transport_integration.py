...
class TestTransportIntegration:
    ...
    def test_get_all_clients(self, mock_validate, mock_fetch, multi_transport_agent_card):
        ...
        for transport_type, client in all_clients.items():
            ...
            required_methods = [
                'send_message', 'send_streaming_message', 'get_task', 
                'cancel_task', 'subscribe_to_task', 'get_agent_card',
                'get_authenticated_extended_card', 'set_push_notification_config',
    ...
    def test_interface_equivalence(self, mock_validate, mock_fetch, multi_transport_agent_card):
        ...
        core_methods = [
            ...
            'get_authenticated_extended_card', 'set_push_notification_config',
            'get_push_notification_config', 'list_push_notification_configs',
            'delete_push_notification_config', 'resubscribe_task'
        ]
    ...
    def test_context_manager_integration(self, mock_validate, mock_fetch, multi_transport_agent_card):
        ...
        class MockClosableClient(BaseTransportClient):
            ...
            def send_message(self, message, **kwargs): pass
            def send_streaming_message(self, message, **kwargs): pass
            def get_task(self, task_id, **kwargs): pass
            def cancel_task(self, task_id, **kwargs): pass
            def resubscribe_task(self, task_id, **kwargs): pass
            def set_push_notification_config(self, task_id, config, **kwargs): pass
            def get_push_notification_config(self, task_id, config_id, **kwargs): pass
            def list_push_notification_configs(self, task_id, **kwargs): pass
            def delete_push_notification_config(self, task_id, config_id, **kwargs): pass
            def get_authenticated_extended_card(self, **kwargs): pass
