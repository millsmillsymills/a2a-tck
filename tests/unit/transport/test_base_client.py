...
class MockTransportClient(BaseTransportClient):
    ...
    def get_push_notification_config(self, task_id: str, config_id: str,
                                   extra_headers: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        return self._record_call("get_push_notification_config", task_id=task_id, config_id=config_id, extra_headers=extra_headers)
    ...
    def delete_push_notification_config(self, task_id: str, config_id: str,
                                       extra_headers: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        return self._record_call("delete_push_notification_config", task_id=task_id, config_id=config_id, extra_headers=extra_headers)
