...
from tests.adapters.base_adapter import (
    BaseTransportAdapter, TestContext, TestResult, TestOutcome
)
...
class TestTransportAdapter(BaseTransportAdapter):
    ...
    def test_get_task(self, context: TestContext, task_id: str, 
        ...
        try:
            def test_func():
                return self.transport_client.get_task(task_id, history_length=history_length, 
