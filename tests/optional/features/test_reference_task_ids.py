...
def text_message_params():
    ...
    return {"message": {"parts": [{"text": "Hello from reference task ID test!"}]}}
...
def test_reference_task_ids_valid(sut_client, text_message_params):
    ...
    params_with_reference = {
        "message": {
            "parts": [{"text": "This message references another task"}],
...
def test_reference_task_ids_invalid(sut_client):
    ...
    params = {
        "message": {
            "parts": [{"text": "This message references a non-existent task"}],
