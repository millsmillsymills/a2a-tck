...
from tests.markers import quality_basic, quality_production
...
def test_empty_arrays(sut_client):
    ...
    assert message_utils.is_json_rpc_error_response(resp, expected_id=req["id"]), "Empty parts array should be rejected"
