...
class TestA2AV030MethodEnhancements:
    ...
    def test_message_send_enhanced_parts_support(self, sut_client: BaseTransportClient):
            ...
            "parts": [
                ...
                },
                {
                    ...
                    "data": {
                        ...
                        "content": {"test": "data", "version": "0.3.0"}
                    }
                }
            ]
        }
        ...
        assert "result" in response or "error" not in response, \
            "Enhanced message parts should be supported in A2A v0.3.0"
        ...
        if "result" in response:
            ...
            assert error.get("code") != -32601, \
                "Enhanced parts should be supported, not method not found"
    ...
    def test_authenticated_extended_card_comprehensive(self, sut_client: BaseTransportClient):
        ...
        enhanced_fields = [
            "version", "description", "capabilities", "skills",
            "securitySchemes", "authentication", "endpoints"
        ]
        ...
        if "securitySchemes" in card:
            ...
            assert isinstance(security_schemes, dict), \
                "Security schemes should be a dictionary"
    ...
    def test_method_parameter_validation_enhancements(self, sut_client: BaseTransportClient):
        ...
        test_cases = [
            {
                "method": "message/send",
                "invalid_params": {"invalid": "structure"},
                "expected_error": "Invalid message structure"
            },
            {
                "method": "tasks/get", 
                "invalid_params": {"invalid": "taskId"},
                "expected_error": "Invalid task ID"
            },
            {
                "method": "tasks/cancel",
        ...
        for test_case in test_cases:
            ...
            if "error" in response:
                ...
                assert error_code == -32602, \
                    f"Expected parameter validation error (-32602), got {error_code}"
    ...
    def test_error_response_enhancements(self, sut_client: BaseTransportClient):
        ...
        if "error" in response:
            ...
            assert error_code == -32001, \
                f"Expected TaskNotFoundError (-32001), got {error_code}"
...
class TestMethodPerformanceAndScaling:
    ...
    def test_method_response_times(self, sut_client: BaseTransportClient):
        ...
        assert response_time < max_response_time, \
            f"Method response time {response_time:.2f}s exceeds limit {max_response_time}s"
