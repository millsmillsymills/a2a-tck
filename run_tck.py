...
def run_all_categories(
    sut_url: str, verbose: bool = False, verbose_log: bool = False, generate_report: bool = False, compliance_report: str = None
):
...
Categories:
  ...
  all                   - All categories in recommended order
    ...
    parser.add_argument(
        "--category", choices=["mandatory", "capabilities", "quality", "features", "all"], help="Test category to run"
    )
