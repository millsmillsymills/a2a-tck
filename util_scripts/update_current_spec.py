    ...
    try:
        ...
        if not args.force:
            ...
            if current_md_file.exists():
                with open(current_md_file, encoding="utf-8") as f:
                    current_md = f.read()
            ...
            if current_json_file.exists():
                with open(current_json_file, encoding="utf-8") as f:
        ...
        logger.info("  2. Run spec analysis: ./check_spec_changes.py")
        logger.info("  3. Update tests as needed")
